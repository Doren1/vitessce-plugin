...
export const ViewHelpMapping = {
  ...
  DEG_PLOT: 'The deg plot displays differential gene expression volcano plot of two selected cell cluster groups, where -LogPValue is along the y-axis and log2FoldChange is along the x-axis.',
  INTERACTION_MATRIX: 'The cell-cell interaction matrix measures how many edges connect nodes of a specific annotation to nodes of other annotations.',
};
